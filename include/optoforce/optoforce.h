...
typedef struct ResponseStruct {
  ...
  int32 ty;
  int32 tz;
} Response; // you make a typedef saying that the 'Response' declaration is now the same as your struct so you can create variables using that 'Response' afterwards
...
public:
  ...
  static void ShowResponse(Response r)
  {
    ...
    if(_kbhit()){
        ...
        if (c == '1'){
            ROS_INFO("6-axis F/T information");
            keyoptioncu = 1;
        }
        else if(c == '2'){
            ROS_INFO("z-axis F information");
            keyoptioncu = 2;
        }
        else{
